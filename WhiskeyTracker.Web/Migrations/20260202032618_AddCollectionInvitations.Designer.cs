...
namespace WhiskeyTracker.Web.Migrations
{
    ...
    [Migration("20260202032618_AddCollectionInvitations")]
    partial class AddCollectionInvitations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WhiskeyTracker.Web.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WhiskeyTracker.Web.Data.CollectionInvitation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("CollectionInvitations");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WhiskeyTracker.Web.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WhiskeyTracker.Web.Data.Bottle", b =>
                {
                    ...
                    b.HasOne("WhiskeyTracker.Web.Data.ApplicationUser", "Purchaser")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("WhiskeyTracker.Web.Data.CollectionInvitation", b =>
                {
                    ...
                    b.HasOne("WhiskeyTracker.Web.Data.ApplicationUser", "InviterUser")
                        .WithMany()

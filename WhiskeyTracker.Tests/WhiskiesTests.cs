...
public class WhiskiesTests : TestBase
{
    ...
    public async Task Create_UploadsFile_AndRedirects()
    {
        ...
        Assert.EndsWith(".jpg", whiskey.ImageFileName); // Confirms filename was generated and ends with extension
    }
    ...
    public async Task Edit_OnPost_HandlesFileUpload()
    {
        ...
        Assert.EndsWith(Path.GetExtension(newFileName), updatedWhiskey.ImageFileName);
